...
Require Export OrienRepr.MathBase.
...
(* rewrite with l2v *)
Definition si2q_l2v (w : R) (v : vec 3) : quat := l2v [w; v.1; v.2; v.3].

Lemma si2q_spec_l2v : forall w v,
    let q := si2q_l2v w v in
...
(* rewrite with l2v *)
Definition q2im_l2v (q : quat) : vec 3 := l2v [q.X; q.Y; q.Z].

Definition im2q (v : vec 3) : quat := vconsH 0 v.

(* rewrite with l2v *)
Definition im2q_l2v (v : vec 3) : quat := l2v [0; v.1; v.2; v.3].

(** q2im (im2q v) = v *)
Lemma q2im_im2q : forall v, q2im (im2q v) = v.
Proof. intros. v2e v. veq. Qed.

Lemma q2im_im2q_l2v : forall v, q2im_l2v (im2q_l2v v) = v.
...
Definition qlen' (q : quat) : R := vlen q.
